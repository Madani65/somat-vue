...
const getMultipleDataSeries = (nameSeries, dataArray = [], index = 'value') => {
  const val = []
...
const getSingleDataSeries = (dataArray = [], index = 'type') => {
  const val = []
  dataArray.forEach(function (data) {
    val.push(data[index])
  })
