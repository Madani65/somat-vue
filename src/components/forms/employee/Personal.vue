            ...
            <v-row>
              ...
              <v-col cols="12" md="6" class="pt-0">
                <v-text-field
                  ...
                  :label="$vuetify.lang.t('$vuetify.personal.npwp')"
                  hide-details="auto"
                  :error-messages="errors['profile.npwp']"
                />
              </v-col>
              <v-col cols="12" md="6" class="pt-0">
                <v-text-field
              ...
              <v-col cols="12" md="6" class="pt-0">
                <v-text-field
                  v-model="profile.title_first"
                  :label="$vuetify.lang.t('$vuetify.personal.title_first')"
                  hide-details="auto"
                  :error-messages="errors['profile.title_first']"
                />
              </v-col>
              <v-col cols="12" md="6" class="pt-0">
                <v-text-field
                  v-model="profile.title_last"
                  :label="$vuetify.lang.t('$vuetify.personal.title_last')"
                  hide-details="auto"
                  :error-messages="errors['profile.title_last']"
                />
              </v-col>
              <v-col cols="12" md="6" class="pt-0">
                <v-text-field
              ...
              <v-col cols="12" md="6" class="pt-0">
                <v-select
                  v-model="profile.marriage_status"
                  :items="marriageStatusList"
                  :label="$vuetify.lang.t('$vuetify.personal.marriage_status')"
                  hide-details="auto"
                  :error-messages="errors['profile.marriage_status']"
                />
              </v-col>
              <v-col cols="12" md="6" class="pt-0">
                <api-select
